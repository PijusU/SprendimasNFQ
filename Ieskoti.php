<?php  
    ...
    $Paieska = htmlspecialchars($_POST['search']);


    $sql = "SELECT * FROM `knygos` WHERE `Pavadinimas` LIKE '$Paieska';";
      ...
      <?php 
        ...
        while($row = $result->fetch_assoc()) {
          echo "<tr><td>";
            ...
            echo "<p>Atsiprašome , paieškos rezultatų nerasta</p>";
        }
        $conn->close();
