<?php  
    ...
    $sql = "SELECT `ID`, `Pavadinimas` FROM `knygos` WHERE 1 LIMIT 20 OFFSET 20;";
	...
	<div class="row">
      ...
      <table class="bordered">
        <thead>
          <tr>
            <ul class="pagination">
                <li class="waves-effect"><a href="index.php"><i class="material-icons">chevron_left</i></a></li>
                ...
                <li class="waves-effect"><a href="Main3.php"><i class="material-icons">chevron_right</i></a></li>
            </ul>
          </tr>
          <tr>
